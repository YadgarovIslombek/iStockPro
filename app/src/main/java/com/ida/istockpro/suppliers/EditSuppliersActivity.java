        ...
        this.textView_Update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (suppliers_name.isEmpty()) {
                    ...
                    EditSuppliersActivity.this.editText_Address.setError(EditSuppliersActivity.this.getString(R.string.enter_suppliers_name));
                    ...
                    EditSuppliersActivity.this.editText_Hp.setError(EditSuppliersActivity.this.getString(R.string.enter_suppliers_name));
