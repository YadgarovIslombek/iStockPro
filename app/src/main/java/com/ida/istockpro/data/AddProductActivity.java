...
//        this.editText_Disc_Qty = findViewById(R.id.et_product_disc_qty);
        ...
        this.textView_Add_Product.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String product_buy = AddProductActivity.this.editText_Buy.getText().toString().trim();
                String product_stock = AddProductActivity.this.editText_Stock.getText().toString().trim();
                String product_price = AddProductActivity.this.editText_Price.getText().toString().trim();
                ...
                if (product_name.isEmpty()) {
                    ...
                    databaseAccess.open();
                    if (databaseAccess.addProduct(product_name, product_code,product_buy, product_price, product_stock, product_weight_unit_id,product_category_id, product_last_update, product_information, product_supplier_id)) {
