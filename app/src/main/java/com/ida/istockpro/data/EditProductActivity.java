        ...
        this.textView_Update_Product.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (product_name.isEmpty()) {
                    ...
                    databaseAccess.open();
                    if (databaseAccess.updateProduct(product_name, product_code, product_buy, product_price, product_stock, product_weight_unit_id, product_category_id,product_last_update, product_information, product_supplier_id, EditProductActivity.this.productID)) {
