...
public class SalesReportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView2.setText(getString(R.string.total_tax) + " (+) : "  + NumberFormat.getInstance(Locale.getDefault()).format(get_tax) + " " + currency);

        databaseAccess.open();
        double get_discount = databaseAccess.getTotalDiscount("all");
        TextView textView3 = this.textView_Discount;
        textView3.setText(getString(R.string.total_discount) + " (-) : " + NumberFormat.getInstance(Locale.getDefault()).format(get_discount) + " " + currency);
    ...
    public void onExport(String path) {
        ...
        new SQLiteToExcel(getApplicationContext(), DatabaseOpenHelper.DATABASE_NAME, directory_path)
                .exportSingleTable("order_details", "Barcha_sotilgan_tovarlar.xls", new SQLiteToExcel.ExportListener() {
