...
public class ExpenseReportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView.setText(getString(R.string.total_expense) + ": "  + NumberFormat.getInstance(Locale.getDefault()).format(this.total_price) + " " + currency);
    }
    ...
    public void onExport(String path) {
        ...
        new SQLiteToExcel(getApplicationContext(), DatabaseOpenHelper.DATABASE_NAME, directory_path)
                .exportSingleTable("expense", "Barcha_chiqimlar.xls", new SQLiteToExcel.ExportListener() {
