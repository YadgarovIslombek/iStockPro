...
package com.ida.istockpro.setting.backup;
...
public class LocalBackup {
    ...
    public void performBackup(final DatabaseOpenHelper db, final String outFileName) {
        ...
        File folder = new File(Environment.getExternalStorageDirectory() + File.separator + "iStockPro/");
        ...
        if (success) {
            ...
            input.setHint("Zahiralash nomini yozing");
            ...
            Toast.makeText(activity, R.string.unable_to_read_contents, Toast.LENGTH_SHORT).show();
    }
            ...
            builderSingle.setAdapter(
                    ...
                    (dialog, which) -> {
                        try {
                            ...
                            Toasty.success(activity.getApplicationContext(), R.string.database_Import_completed, Toast.LENGTH_SHORT).show();
                        }
                    });
            builderSingle.show();
        } else
