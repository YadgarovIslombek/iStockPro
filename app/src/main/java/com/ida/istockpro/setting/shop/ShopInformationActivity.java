package com.ida.istockpro.setting.shop;
        ...
        this.textView_Update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (shop_name.isEmpty()) {
                    ...
                    ShopInformationActivity.this.editText_Contact.setError(ShopInformationActivity.this.getString(R.string.shop_name_cannot_be_empty));
                    ...
                    ShopInformationActivity.this.editText_Email.setError(ShopInformationActivity.this.getString(R.string.shop_name_cannot_be_empty));
                    ShopInformationActivity.this.editText_Email.requestFocus();
                } else if (shop_address.isEmpty()) {
                    ShopInformationActivity.this.editText_Address.setError(ShopInformationActivity.this.getString(R.string.shop_name_cannot_be_empty));
                    ShopInformationActivity.this.editText_Address.requestFocus();
                } else if (shop_currency.isEmpty()) {
                    ShopInformationActivity.this.editText_Currency.setError(ShopInformationActivity.this.getString(R.string.shop_name_cannot_be_empty));
