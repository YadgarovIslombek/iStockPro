package com.ida.istockpro.setting.users;
...
public class EditUserActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String userType=getIntent().getExtras().getString(DatabaseOpenHelper.USER_TYPE);
        ...
        etxtUserType.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final String[] userType = {"Admin", "Kassir","Skladchi"};
