...
//                Log.d("test","qty "+qty + "price " + price + stockPrd + String.valueOf(test));
    ...
    // AddProductActivity
    public boolean addProduct(String product_name, String product_code, String product_buy, String product_price, String product_stock, String weight_unit_id, String product_category, String product_last_update, String product_information, String product_supplier) {
        ContentValues values = new ContentValues();
    ...
    // EditProductActivity
    public boolean updateProduct(String product_name, String product_code,String product_buy, String product_price,String product_stock, String weight_unit_id, String product_category, String product_last_update, String product_information, String product_supplier, String product_id) {
        ContentValues values = new ContentValues();
        values.put(DatabaseOpenHelper.PRODUCT_NAME, product_name);
        values.put(DatabaseOpenHelper.PRODUCT_CODE, product_code);
        values.put(DatabaseOpenHelper.PRODUCT_BUY, product_buy);
