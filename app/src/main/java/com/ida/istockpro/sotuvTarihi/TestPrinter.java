...
import com.ida.istockpro.utils.IPrintToPrinter;
...
public class TestPrinter implements IPrintToPrinter {
    ...
    public void printContent(WoosimPrnMng prnMng) {
        ...
        prnMng.printStr("Telefon raqam: " + this.shopContact, 1, WoosimCmd.ALIGN_CENTER);
        prnMng.printStr("Email: " + this.shopEmail, 1, WoosimCmd.ALIGN_CENTER);
        prnMng.printStr("Invoys ID: " + this.invoiceId, 1, WoosimCmd.ALIGN_CENTER);
        prnMng.printStr("Vaqt: " + this.orderTime + " " + this.orderDate, 1, WoosimCmd.ALIGN_CENTER);
        ...
        prnMng.printStr("--------------------------------");
        prnMng.printStr("Jami: " + this.currency + " " + NumberFormat.getInstance(Locale.getDefault()).format(this.subTotal), 1, WoosimCmd.ALIGN_RIGHT);
        prnMng.printStr("Xizmat uchun (+): " + this.currency + " " + NumberFormat.getInstance(Locale.getDefault()).format(getTax), 1, WoosimCmd.ALIGN_RIGHT);
        prnMng.printStr("Skidka (-): " + this.currency + " " + NumberFormat.getInstance(Locale.getDefault()).format(getDiscount), 1, WoosimCmd.ALIGN_RIGHT);
        prnMng.printStr("--------------------------------");
        prnMng.printStr("Jami to'lov: " + this.currency + " " + NumberFormat.getInstance(Locale.getDefault()).format(this.totalPrice), 1, WoosimCmd.ALIGN_RIGHT);
